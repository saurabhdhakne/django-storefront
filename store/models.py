...
class Order(models.Model):
    ...
    payment = models.CharField(max_length=1, choices=PAYMENT_STATUS_CHOICES, default=PAYMENT_STATUS_PENDING) # auto_now_add will update at one when it is created
...
class Addres(models.Model):
    ...
    customer = models.ForeignKey('Customer', on_delete=models.CASCADE) # PROTECT, CASCADE many more
